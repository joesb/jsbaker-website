...
<figure class="content-canvas-item-right content-canvas-item-right--span-4 picture--block">
  {% Markdown true %}!["Lessons in Chemistry book cover"](/static/images/source/books/garmus-lessons-in-chemistry.jpeg){.picture-outline}{% endMarkdown %}
</figure>
...
<figure class="content-canvas-item-right content-canvas-item-right--span-4 picture--block">
  {% Markdown true %}!["Grief is the Thing with Feathers book cover"](/static/images/source/books/porter-grief-is-the-thing-with-feathers.jpeg){.picture-outline}{% endMarkdown %}
</figure>
...
<figure class="content-canvas-item-right content-canvas-item-right--span-4 picture--block">
  {% Markdown true %}!["Bad Relations book cover"](/static/images/source/books/connolly-bad-relations.jpeg){.picture-outline}{% endMarkdown %}
</figure>
...
<figure class="content-canvas-item-right content-canvas-item-right--span-4 picture--block">
  {% Markdown true %}!["Spring book cover"](/static/images/source/books/smith-spring.jpeg){.picture-outline}{% endMarkdown %}
</figure>
